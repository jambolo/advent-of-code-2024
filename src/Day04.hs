...
-- loadArray loads an array from a list of lists
createPuzzle :: [[Char]] -> Array (Int, Int) Char
createPuzzle a =
    let nRows = length a
        nCols = length (head a)
...
checkXmas :: Array (Int, Int) Char -> (Int, Int) -> (Int, Int) -> Bool
...
findMatches :: Array (Int, Int) Char -> (Int, Int) -> ((Int, Int), (Int, Int)) -> [Bool]
findMatches puzzle d ((top, left), (bottom, right)) = [checkXmas puzzle (i, j) d | i <- [top .. bottom], j <- [left .. right]]

countMatches :: Array (Int, Int) Char -> (Int, Int) -> ((Int, Int), (Int, Int)) -> Int
...
checkX :: Array (Int, Int) Char -> (Int, Int) -> Bool
...
findXs :: Array (Int, Int) Char -> ((Int, Int), (Int, Int)) -> [Bool]
